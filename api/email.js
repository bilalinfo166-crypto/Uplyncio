...
function footer() {
  ...
  return `
  <tr><td style="background:linear-gradient(135deg,#0f1628 0%,#1a2d5a 100%);padding:20px 28px">
    <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
      <td style="vertical-align:middle;width:45%">
        <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom:8px"><tr>
          <td style="vertical-align:middle;padding-right:8px"><img src="data:image/png;base64,${lb}" width="30" height="30" alt="Uplyncio" style="display:block;border-radius:7px;border:0"/></td>
          <td style="vertical-align:middle"><span style="font-family:Arial,sans-serif;font-size:15px;font-weight:900;color:#fff;letter-spacing:-0.3px">Uply<span style="color:#4f7cff">ncio</span></span></td>
        </tr></table>
        <p style="font-family:Arial,sans-serif;font-size:10.5px;color:#8892a4;margin:0;line-height:1.6">Premium guest posting &amp; link building marketplace.<br>20,000+ verified publisher sites.</p>
      </td>
      <td style="vertical-align:top;text-align:right;width:55%">
        <p style="font-family:Arial,sans-serif;font-size:11.5px;margin:0 0 8px">
          <a href="${SITE}" style="color:rgba(255,255,255,.5);text-decoration:none;margin-left:14px">Home</a>
          <a href="${SITE}/buyer.html" style="color:rgba(255,255,255,.5);text-decoration:none;margin-left:14px">Marketplace</a>
          <a href="${SITE}/publisher.html" style="color:rgba(255,255,255,.5);text-decoration:none;margin-left:14px">Publishers</a>
          <a href="mailto:info@uplyncio.com" style="color:rgba(255,255,255,.5);text-decoration:none;margin-left:14px">Contact</a>
        </p>
        <p style="margin:0 0 8px">
          <a href="https://www.linkedin.com/company/uplyncio" style="display:inline-block;width:24px;height:24px;border-radius:6px;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.06);text-align:center;line-height:24px;font-family:Arial,sans-serif;font-size:9px;font-weight:700;color:rgba(255,255,255,.6);text-decoration:none;margin-left:4px">in</a>
          <a href="https://www.facebook.com/profile.php?id=61579091653953" style="display:inline-block;width:24px;height:24px;border-radius:6px;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.06);text-align:center;line-height:24px;font-family:Arial,sans-serif;font-size:9px;font-weight:700;color:rgba(255,255,255,.6);text-decoration:none;margin-left:4px">fb</a>
          <a href="https://www.instagram.com/uplyncio" style="display:inline-block;width:24px;height:24px;border-radius:6px;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.06);text-align:center;line-height:24px;font-family:Arial,sans-serif;font-size:9px;font-weight:700;color:rgba(255,255,255,.6);text-decoration:none;margin-left:4px">ig</a>
          <a href="https://wa.me/923001234567" style="display:inline-block;width:24px;height:24px;border-radius:6px;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.06);text-align:center;line-height:24px;font-family:Arial,sans-serif;font-size:9px;font-weight:700;color:rgba(255,255,255,.6);text-decoration:none;margin-left:4px">wa</a>
          <a href="https://twitter.com/uplyncio" style="display:inline-block;width:24px;height:24px;border-radius:6px;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.06);text-align:center;line-height:24px;font-family:Arial,sans-serif;font-size:9px;font-weight:700;color:rgba(255,255,255,.6);text-decoration:none;margin-left:4px">X</a>
        </p>
        <p style="font-family:Arial,sans-serif;font-size:10px;color:rgba(255,255,255,.25);margin:0">
          <a href="${SITE}/privacy.html" style="color:rgba(255,255,255,.25);text-decoration:none;margin-left:8px">Privacy</a>
          <a href="${SITE}/terms.html" style="color:rgba(255,255,255,.25);text-decoration:none;margin-left:8px">Terms</a>
          <span style="margin-left:8px">&copy; 2026 Uplyncio</span>
        </p>
      </td>
    </tr></table>
