...
function footer() {
  return (
    ...
    + '<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>'
    + '<td style="vertical-align:middle">'
    + '<p style="font-family:Arial,sans-serif;font-size:15px;font-weight:900;color:#fff;margin:0 0 3px">Uply<span style="color:#4f7cff">ncio</span></p>'
    ...
    + '<p style="font-family:Arial,sans-serif;font-size:11px;color:rgba(255,255,255,.3);margin:0 0 3px">'
    ...
    + '<a href="mailto:info@uplyncio.com" style="color:rgba(255,255,255,.25);text-decoration:none">info@uplyncio.com</a>'
    + ' &nbsp;|&nbsp; &copy; 2026 Uplyncio'
    + '</p>'
    + '</td>'
    + '</tr></table>'
    + '<p style="font-family:Arial,sans-serif;font-size:10px;color:rgba(255,255,255,.15);text-align:center;margin:10px 0 0;border-top:1px solid rgba(255,255,255,.06);padding-top:10px">This is an automated message &mdash; please do not reply directly to this email.</p>'
    + '</td></tr>'
  );
}
