...
function footer() {
  return (
    ...
    + '<p style="font-family:Arial,sans-serif;font-size:15px;font-weight:900;color:#fff;margin:0 0 6px">Uply<span style="color:#4f7cff">ncio</span></p>'
    ...
    + '<a href="https://uplyncio.com" style="color:rgba(255,255,255,.5);text-decoration:none;margin-left:14px">Home</a>'
    + '<a href="https://uplyncio.com/buyer.html" style="color:rgba(255,255,255,.5);text-decoration:none;margin-left:14px">Marketplace</a>'
    + '<a href="https://uplyncio.com/publisher.html" style="color:rgba(255,255,255,.5);text-decoration:none;margin-left:14px">Publishers</a>'
    + '</p>'
