...
function footer() {
  ...
  return (
    '<tr><td style="background:linear-gradient(135deg,#0f1628 0%,#1a2d5a 100%);padding:20px 24px;border-radius:0 0 12px 12px">'
    + '<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>'
    + '<td style="vertical-align:middle;width:45%">'
    + '<table cellpadding="0" cellspacing="0" border="0" style="margin-bottom:8px"><tr>'
    + '<td style="vertical-align:middle;padding-right:8px"><img src="data:image/png;base64,' + lb + '" width="28" height="28" alt="" style="display:block;border-radius:7px;border:0"/></td>'
    + '<td style="vertical-align:middle"><span style="font-family:Arial,sans-serif;font-size:14px;font-weight:900;color:#fff">Uply<span style="color:#4f7cff">ncio</span></span></td>'
    + '</tr></table>'
    + '<p style="font-family:Arial,sans-serif;font-size:10px;color:#8892a4;margin:0;line-height:1.5">Guest posting &amp; link building marketplace.<br>20,000+ verified publisher sites.</p>'
    + '</td>'
    + '<td style="vertical-align:top;text-align:right;width:55%">'
    + '<p style="font-family:Arial,sans-serif;font-size:11px;margin:0 0 7px">'
    + '<a href="https://uplyncio.com" style="color:rgba(255,255,255,.5);text-decoration:none;margin-left:12px">Home</a>'
    + '<a href="https://uplyncio.com/buyer.html" style="color:rgba(255,255,255,.5);text-decoration:none;margin-left:12px">Marketplace</a>'
    + '<a href="https://uplyncio.com/publisher.html" style="color:rgba(255,255,255,.5);text-decoration:none;margin-left:12px">Publishers</a>'
    + '</p>'
    + '<p style="margin:0 0 7px">'
    + '<a href="https://www.linkedin.com/company/uplyncio" style="display:inline-block;width:22px;height:22px;border-radius:5px;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.06);text-align:center;line-height:22px;font-family:Arial,sans-serif;font-size:9px;font-weight:700;color:rgba(255,255,255,.6);text-decoration:none;margin-left:4px">in</a>'
    + '<a href="https://www.facebook.com/profile.php?id=61579091653953" style="display:inline-block;width:22px;height:22px;border-radius:5px;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.06);text-align:center;line-height:22px;font-family:Arial,sans-serif;font-size:9px;font-weight:700;color:rgba(255,255,255,.6);text-decoration:none;margin-left:4px">fb</a>'
    + '<a href="https://www.instagram.com/uplyncio" style="display:inline-block;width:22px;height:22px;border-radius:5px;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.06);text-align:center;line-height:22px;font-family:Arial,sans-serif;font-size:9px;font-weight:700;color:rgba(255,255,255,.6);text-decoration:none;margin-left:4px">ig</a>'
    + '<a href="https://wa.me/923001234567" style="display:inline-block;width:22px;height:22px;border-radius:5px;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.06);text-align:center;line-height:22px;font-family:Arial,sans-serif;font-size:9px;font-weight:700;color:rgba(255,255,255,.6);text-decoration:none;margin-left:4px">wa</a>'
    + '<a href="https://twitter.com/uplyncio" style="display:inline-block;width:22px;height:22px;border-radius:5px;border:1px solid rgba(255,255,255,.15);background:rgba(255,255,255,.06);text-align:center;line-height:22px;font-family:Arial,sans-serif;font-size:9px;font-weight:700;color:rgba(255,255,255,.6);text-decoration:none;margin-left:4px">X</a>'
    + '</p>'
    + '<p style="font-family:Arial,sans-serif;font-size:10px;color:rgba(255,255,255,.25);margin:0">'
    + '<a href="https://uplyncio.com/privacy.html" style="color:rgba(255,255,255,.25);text-decoration:none;margin-left:8px">Privacy</a>'
    + '<a href="https://uplyncio.com/terms.html" style="color:rgba(255,255,255,.25);text-decoration:none;margin-left:8px">Terms</a>'
    + '<span style="margin-left:8px">&copy; 2026 Uplyncio</span>'
    + '</p>'
    + '</td>'
    + '</tr></table>'
    + '<p style="font-family:Arial,sans-serif;font-size:10px;color:rgba(255,255,255,.18);text-align:center;margin:10px 0 0;border-top:1px solid rgba(255,255,255,.06);padding-top:10px">This is an automated message &mdash; please do not reply directly to this email.</p>'
    + '</td></tr>'
  );
}
