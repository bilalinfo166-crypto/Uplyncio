...
function footer() {
  ...
  return (
    '<tr><td style="background:linear-gradient(135deg,#0f1628 0%,#1a2d5a 100%);padding:18px 24px;border-radius:0 0 12px 12px">'
    + '<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>'
    ...
    + '<p style="font-family:Arial,sans-serif;font-size:11px;color:rgba(255,255,255,.3);margin:0 0 4px">'
    + '<a href="https://uplyncio.com/privacy.html" style="color:rgba(255,255,255,.3);text-decoration:none;margin-left:12px">Privacy</a>'
    + '<a href="https://uplyncio.com/terms.html" style="color:rgba(255,255,255,.3);text-decoration:none;margin-left:12px">Terms</a>'
    + '<a href="https://www.linkedin.com/company/uplyncio" style="color:rgba(255,255,255,.3);text-decoration:none;margin-left:12px">LinkedIn</a>'
    + '<a href="https://www.facebook.com/profile.php?id=61579091653953" style="color:rgba(255,255,255,.3);text-decoration:none;margin-left:12px">Facebook</a>'
    + '</p>'
    + '<p style="font-family:Arial,sans-serif;font-size:10px;color:rgba(255,255,255,.2);margin:0">'
    + '<a href="mailto:info@uplyncio.com" style="color:rgba(255,255,255,.2);text-decoration:none">info@uplyncio.com</a>'
    + ' &nbsp;|&nbsp; &copy; 2026 Uplyncio'
    + '</p>'
    + '</td>'
    + '</tr></table>'
    + '<p style="font-family:Arial,sans-serif;font-size:10px;color:rgba(255,255,255,.12);text-align:center;margin:10px 0 0;border-top:1px solid rgba(255,255,255,.06);padding-top:10px">This is an automated message &mdash; please do not reply directly to this email.</p>'
    + '</td></tr>'
  );
}
