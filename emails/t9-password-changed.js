// Template 9: Password Changed (from settings, not reset)

export function passwordChangedTemplate({ name, email, changedAt, ipAddress }) {
  return `
  ...
  <tr><td style="padding:28px">
    ...
    <p style="font-family:Arial,sans-serif;font-size:14px;color:#64748b;margin:0 0 20px;line-height:1.7">
      Hi <strong style="color:#1a202c">${name}</strong>, your Uplyncio account password was changed
      successfully. This is a security confirmation that your account settings have been updated.
    </p>
      ...
      <tr>
        <td style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:16px">
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td style="font-family:Arial,sans-serif;font-size:13px;color:#64748b;padding:5px 0">Account</td>
              <td align="right" style="font-family:Arial,sans-serif;font-size:13px;font-weight:600;color:#1a202c;padding:5px 0">${email}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="font-family:Arial,sans-serif;font-size:13px;color:#64748b;padding:5px 0">IP Address</td>
              <td align="right" style="font-family:Arial,sans-serif;font-size:13px;font-weight:600;color:#1a202c;padding:5px 0">${ipAddress || 'Unknown'}</td>
            </tr>
          </table>
        </td>
      </tr>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:16px">
      <tr>
        <td style="background:#f8faff;border:1px solid #e0e7ff;border-radius:8px;padding:12px 14px">
          <p style="font-family:Arial,sans-serif;font-size:13px;color:#475569;margin:0 0 8px;line-height:1.6">
            🔒 <strong style="color:#1a202c">Keep your account secure:</strong>
          </p>
