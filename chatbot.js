...
(function() {
  ...
  var STYLE = `
    ...
    #ace-box{position:fixed;top:16px;bottom:92px;right:24px;width:380px;background:#fff;border-radius:20px;box-shadow:0 24px 80px rgba(0,0,0,.2),0 0 0 1px rgba(0,0,0,.05);z-index:99999;display:none;flex-direction:column;overflow:hidden;font-family:'Plus Jakarta Sans',Arial,sans-serif}
    ...
    @media(max-width:420px){#ace-box{width:calc(100vw - 16px);right:8px;top:10px;bottom:84px}}
  `;
