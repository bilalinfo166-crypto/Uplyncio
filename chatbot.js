...
(function() {
  ...
  var STYLE = `
    ...
    #ace-box{position:fixed;bottom:96px;right:24px;width:400px;max-height:min(600px, calc(100vh - 120px));height:580px;background:#fff;border-radius:20px;box-shadow:0 24px 80px rgba(0,0,0,.2),0 0 0 1px rgba(0,0,0,.05);z-index:99999;display:none;flex-direction:column;overflow:hidden;font-family:'Plus Jakarta Sans',Arial,sans-serif}
    ...
    @media(max-width:420px){#ace-box{width:calc(100vw - 16px);right:8px;bottom:90px;max-height:calc(100dvh - 110px);height:520px}}
  `;
